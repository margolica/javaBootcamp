...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    public void update(Message message) {
        String sqlMessageUpdate = "UPDATE message SET author_id = ?, room_id = ?, text = ?, date = ? Where id = ?";
        PreparedStatement preparedStatement = null;
        try {
            preparedStatement = dataSource.getConnection().prepareStatement(sqlMessageUpdate);
